...
import { PanelTitle, RenameButton, SwatchRow, panelBodyStyle, panelWrapStyle } from './panelPrimitives';
  ...
  return (
    <div data-props-panel style={panelWrapStyle(th, isMobile, !!controller.saveConflict, short)}>
      <div style={panelBodyStyle(isMobile)}>
        ...
        <SwatchRow label="영역 색상" theme={th} palette={th.palette} current={z.color} onPick={(hex) => controller.setZoneColor(zoneId, hex)} onReset={() => controller.setZoneColor(zoneId, null)} />
