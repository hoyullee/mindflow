      ...
      >
        ...
        <div style={{ padding: 24 }}>
          ...
          <div
            ...
            style={{ display: 'flex', alignItems: 'center', gap: 13, padding: '15px 16px', borderRadius: 14, background: 'var(--mf-danger-bg)', cursor: 'pointer' }}
          >
            {/* 첨부 이미지: 아이콘 상자 없이 휴지통 아이콘이 바로 서고, 제목은
                빨강이 아니라 잉크 — 위험 신호는 면 색과 아이콘이 이미 말한다. */}
